...
const movieList = function(req, res) {
  res.render("movie-list", {
    ...
    pageHeader: {
      ...
      message: "Our current feature films are some of Hollywood's best and most talked about creations. Select the button below a film to find out more details."
		},
    movies: [{
      id: "#1",
      title: "Casablanca",
